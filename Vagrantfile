...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "eugenex9-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/eugenex9"
  #   chef.validation_client_name = "eugenex9-validator"
  #   chef.validation_key_path = ".chef/eugenex9-validator.pem"
  # end
end
